...
<html>
  <head>
    ...
    <title>REGULAR SYSTEM MAINTENANCE</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
  ...
  <body class="">
    <span class="preheader">REGULAR SYSTEM MAINTENANCE</span>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td><p>Game company: <b>${GSP_NAME}</b><p></td>
                                    </tr>
                                    <tr>
                                      <td><p>Schedule: <b>${FROM} to ${TO}</b><p></td>
                                    </tr>
                                    <tr>
                                      <td><p>Miscellaneous: <b>This is a regular system check.</b><p></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">NetLingo Support Services Inc.</span>
                    <br> Don't like these emails? <a href="http://aplus777.com">Unsubscribe</a>.
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="http://aplus777.com">aplus777</a>.
                  </td>
                </tr>
              </table>
            </div>
